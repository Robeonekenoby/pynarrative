"""
This module provides the NextStep class for creating call-to-action elements
elements in Story views. It is designed to work in conjunction with the Story class
class to create narrative data visualisations.
"""

class NextStep:
    """
    Class for creating call-to-action elements in Story visualisations.
    ...
    def to_dict(self):
        """
        Converts the configuration into a dictionary compatible with Story.add_call_to_action.
