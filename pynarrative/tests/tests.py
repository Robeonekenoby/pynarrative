...
class TestCallToAction(unittest.TestCase):
    ...
    def test_line_steps_call_to_action(self):
        """Call-to-action test with line steps."""
    ...
    def test_stair_steps_call_to_action(self):
        """Call-to-action test with stair steps."""
        texts = ["Step 1", "Step 2"]
    ...
    def test_nextstep_button(self):
        """Test call-to-action with NextStep button."""
        button = NextStep(
            type='button',
            text='Click me',
    ...
    def test_nextstep_line_steps(self):
        """Call-to-action testing with NextStep line steps."""
        line = NextStep(
            type='line_steps',
            texts=['Step 1', 'Step 2', 'Step 3']
        )
    ...
    def test_nextstep_stair_steps(self):
        """Test call-to-action with NextStep stair steps."""
        stairs = NextStep(
            type='stair_steps',
